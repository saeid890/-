...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐒𝐀𝐄𝐈𝐃 \\____😘😈🩵🪽 তাকে সবাই সাইদ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami saeid") || (event.body.toLowerCase() == "চুপ সালা আমি সাইদ") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন, আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "সাদিয়া") || (event.body.toLowerCase() == "সুমাইয়া")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে কেউ ডাক দিবানা এটা আমার বস সাইদ এর বউ এর নাম 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "তানহা") || (event.body.toLowerCase() == "নুসরাত")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সাইদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "লামিয়া") || (event.body.toLowerCase() == "মিম")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সাইদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "আরোহি")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সাইদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "tamim") || (event.body.toLowerCase() == "তামিম")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hmm")) {
     return api.sendMessage("️হুম হুম চোদাইস না আমার বস সাইদ এর মাথা এমনিতেই গরম আছে 🤬⛏️😷", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️কিরে বোকাচোদা এইদিক ওইদিক কি দেখোস 😒😛", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "তুমি কি আমাকে ভালোবাসাে")) {
